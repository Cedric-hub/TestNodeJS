// Commande à executer dans le terminal pour télécharger https://www.npmjs.com/ :
// npm i request
...
//         if (element == tab[i]) return 'element appartient à tab'
//     }
//     return 'element n\'appartient pas à tab'
// };

// console.log(verif(tab, element));
...
// fin s'affiche avant car promesse : asynchrone
console.log("fin");
